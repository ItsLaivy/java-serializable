...
final class MonthDayJsonAdapter implements JsonAdapter<MonthDay> {
    ...
    @Override
    public @Nullable JsonElement serialize(@NotNull TestJson serializer, @Nullable MonthDay instance) throws InvalidClassException {
        if (instance == null) {
            return null;
        } else {
    ...
    @Override
    public @Nullable MonthDay deserialize(@NotNull TestJson serializer, @NotNull Class<MonthDay> reference, @Nullable JsonElement json) throws InvalidClassException {
