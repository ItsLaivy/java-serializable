...
final class YearMonthJsonAdapter implements JsonAdapter<YearMonth> {
    ...
    @Override
    public @Nullable JsonElement serialize(@NotNull JsonSerializable serializer, @Nullable YearMonth instance) throws InvalidClassException {
        if (instance == null) {
            return null;
        } else {
    ...
    @Override
    public @Nullable YearMonth deserialize(@NotNull JsonSerializable serializer, @NotNull Class<YearMonth> reference, @Nullable JsonElement json) throws InvalidClassException {
