    ...
    public @Nullable Object read(@NotNull Class<?> reference, @NotNull Serializer serializer, @NotNull Context context, @NotNull Config config) throws IOException, InstantiationException {
        ...
        if (adapter != null) {
            ...
            if (!isConcrete(reference)) {
                throw new IllegalConcreteTypeException("the reference '" + reference.getName() + "' isn't concrete: " + config);
            }
        ...
        throw new IllegalStateException("the reference object '" + reference.getName() + "' is missing adapters: " + context + ", configuration: " + config);
    }
